  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col justify-center px-4 pb-14 pt-8 sm:px-6 sm:pb-20 sm:pt-12">
      <div className="hero-rise max-w-2xl">
        ...
        <div className="mt-7 max-w-md rounded-2xl border border-line bg-surface p-4 shadow-sm sm:p-5">
          <AnschriftFeld
            id="hero-anschrift"
          ...
          <a
            href="#rechner"
            className="mt-4 block w-full rounded-lg bg-accent px-4 py-2.5 text-center text-base font-semibold text-on-accent transition-colors hover:bg-accent-strong"
          >
